                    ...
                    <form action="akses_promo.php" method="post">
                      <div class="form-group">
                        <div class="col-md-6">                        
                          ...
                          <input class="form-control py-4" name="nama" type="text" placeholder="Masukkan nama promo" />
                        </div>
                        <div class="col-md-6">                        
                          <label class="small mb-1" for="diskon">Diskon</label>
                          <input class="form-control py-4" name="diskon" type="text" placeholder="Masukkan diskon" />
                        </div>
