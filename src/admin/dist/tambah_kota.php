...
<html lang="en">
    <head>
        ...
        <title>Tambah Wilayah Ongkir</title>
        ...
        <?php include "./navbar.php" ?>
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <form action="akses_kota.php" method="post">
                      <div class="form-group">
                        <div class="col-md-6">                        
                          <label class="small mb-1" for="nama">Nama Kota</label>
                          <input class="form-control py-4" name="nama" type="text" placeholder="Masukkan nama kota" />
                        </div>
                        <div class="col-md-6">                        
                          <label class="small mb-1" for="diskon">Harga Ongkir</label>
                          <input class="form-control py-4" name="harga" type="text" placeholder="Masukkan harga" />
                        </div>
